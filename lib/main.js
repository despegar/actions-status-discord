...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield Promise.all(inputs.webhooks.map(w => wrapWebhook(w.trim(), payload, inputs.proxyHost, inputs.proxyPort)));
        }
        catch (e) {
...
function wrapWebhook(webhook, payload, proxyHost, proxyPort) {
    return function () {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const config = proxyHost && proxyPort ? { proxy: { host: proxyHost, port: proxyPort } } : {};
                yield axios_1.default.post(webhook, payload, config);
            }
            catch (e) {
                if (e.response) {
