...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            core_1.endGroup();
            core_1.startGroup('Proxy config');
            utils_1.logInfo(`http_proxy -> ${process.env['http_proxy'] || process.env['HTTP_PROXY'] || 'no http proxy setted'}`);
            utils_1.logInfo(`https_proxy -> ${process.env['https_proxy'] || process.env['HTTPS_PROXY'] || 'no https proxy setted'}`);
            core_1.endGroup();
    ...
    return function () {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (proxy) {
                    const agent = http_proxy_agent_1.default({ host, port, rejectUnauthorized: false });
